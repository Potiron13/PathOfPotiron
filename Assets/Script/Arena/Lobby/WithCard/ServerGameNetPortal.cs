...
using UnityEngine.SceneManagement;
    ...
    public class ServerGameNetPortal : MonoBehaviour
    {
        ...
        private Dictionary<string, PlayerStruct> clientData;
        ...
        private void Start()
        {
            ...
            clientData = new Dictionary<string, PlayerStruct>();
        ...
        public PlayerStruct? GetPlayerStruct(ulong clientId)
        {
            if (clientIdToGuid.TryGetValue(clientId, out string clientGuid))
            {
                if (clientData.TryGetValue(clientGuid, out PlayerStruct playerData))
                {
                    return playerData;
                }
                else
        ...
        private void HandleServerStarted()
        {
            ...
            clientData.Add(clientGuid, new PlayerStruct(playerName, NetworkManager.Singleton.LocalClientId));
        ...
        private void ApprovalCheck(byte[] connectionData, ulong clientId, NetworkManager.ConnectionApprovedDelegate callback)
        {
            ...
            if (gameReturnStatus == ConnectStatus.Success)
            {
                ...
                clientData[connectionPayload.clientGUID] = new PlayerStruct(connectionPayload.playerName, clientId);
            }
